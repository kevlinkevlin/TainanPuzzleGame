...
namespace Fungus
{
    ...
    public class SaveMenu : MonoBehaviour 
    {
        ...
        public virtual void GoToTheScene()
        {
        ...
        public virtual void ToggleSaveMenu()
        {
            ...
            if (saveMenuActive)
            {
             ...
             //   saveButton.gameObject.SetActive(false);
                // Switch menu off
                LeanTween.value(saveMenuGroup.gameObject, saveMenuGroup.alpha, 0f, 0.1f).setOnUpdate( (t) => { 
           ...
           //     saveButton.gameObject.SetActive(true);
                // Switch menu on
                LeanTween.value(saveMenuGroup.gameObject, saveMenuGroup.alpha, 1f, 0.1f).setOnUpdate( (t) => { 
                    saveMenuGroup.alpha = t;
                }).setOnComplete( () => {
